...
public class Main {
    public static void main(String[] args) {
            ...
            Product c1 = new Clothing("M", "Black", "Cotton", 0.5, 50.0,
                    "Nike", 101, "T-Shirt", 299.99,
                    null, "Comfortable cotton t-shirt", 20);

            Product c2 = new Clothing("L", "Blue", "Denim", 1.2, 80.0,
            ...
            Product laptop1 = new Laptops(2, 65, 1.8, 20, "Dell", 1, "XPS 15",
                    1500, null, "High performance laptop", 10,
                    "16GB", "512GB SSD", "Intel i7");

            Product laptop2 = new Laptops(1, 60, 1.6, 25, "Apple", 2, "MacBook Pro",
            ...
            Product phone1 = new Phones(2, 15, 0.18, 10, "Samsung", 101, "Galaxy S24",
                    1200, null, "Flagship phone", 20, 50, 5000);

            Product phone2 = new Phones(1, 12, 0.17, 12, "Apple", 102, "iPhone 15",
            ...
            Product s1 = new SoftwareLicense(
                    "ABC123-XYZ789",
            ...
            Product s2 = new SoftwareLicense(
                    "QWE456-RTY111",
            ...
            Product d1 = new DigitalDownload(
                    "MP3",
                    5,
                    120.5,
            ...
            Product d2 = new DigitalDownload(
                    "PDF",
                    3,
                    15.2,
